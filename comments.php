 ...
 * handled by a callback to dj_comment() which is
...
<?php if ( post_password_required() ) : ?>
	<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'dj' ); ?></p>
</div><!-- #comments -->
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'dj' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'dj' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'dj' ) ); ?></div>
		</nav>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use dj_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define dj_comment() and that will be used instead.
				 * See dj_comment() in dj/functions.php for more.
				 */
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'dj' ); ?></p>
	<?php endif; ?>
